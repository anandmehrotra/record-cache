  ...
  module Strategy
    class UniqueIndexCache < Base
      ...
      def fetch_records(query)
        ...
        id_to_version_key_map = Hash[id_to_key_map.map{ |id, key| current_versions[id] ? [id, versioned_key(key, current_versions[id])] : [] }]
        ...
        log_id_cache_hit(ids, id_to_key_map.keys)
